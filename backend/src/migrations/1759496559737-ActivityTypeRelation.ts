...
export class ActivityTypeRelation1759496559737 implements MigrationInterface {
    name = 'ActivityTypeRelation1759496559737'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`activity\` CHANGE \`type_id\` \`type_id\` varchar(36) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`activity\` DROP FOREIGN KEY \`FK_3571467bcbe021f66e2bdce96ea\``);
        await queryRunner.query(`ALTER TABLE \`activity\` CHANGE \`type_id\` \`type_id\` varchar(36) NULL DEFAULT 'NULL'`);
